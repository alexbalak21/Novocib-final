...
<div class="container mt-5">
    ...
    <p class="col-lg-10 mx-auto text-center mb-5">
        <strong class="lead">Using ion-paired high-performance liquid chromatography with diode array detection <span class="novo-blue">NOVOCIB</span> provides HPLC analytical services of full spectra of nucleotides in cell extracts and in feed/ food products and ingredients.</strong>
    </p>
    ...
    <article class="row">
        ...
        <div class="col-lg-6 list-1 d-flex align-items-center">
            <div>
                <h4 class="mt-4 novo-blue">Nucleotides are present in cells in different forms:</h4>
                <ul>
                    <li>
