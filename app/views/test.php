        ...
        <form id="contact-page-form" action="/save-info" method="POST" name="contact-page-form">
            <div class="row mt-4 mb-2">
                ...
                <section class="payment_info position-relative">
                    <i style="font-size: 2rem; position: absolute; top:30px; left:12px;" class="fa-regular fa-credit-card ms-2"></i>
                    <div class="w-100">
                        <h2 class="underlinedTitl pt-4 mb-4 text-center"><span class="underlined novoblue">Card Information</span></h2>
                    </div>
