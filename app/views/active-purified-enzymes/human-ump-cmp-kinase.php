...
<table class="table product mb-2">
    ...
    <tbody>
        <tr>
            ...
            <td class="text-end pe-3"><a class="btn btn-primary" href="/inquiry?ref=K0709-01-2&amp;product=Human UMP-CMP Kinase - 1 Unit">Inquiry <i class="fa-solid fa-comment"></i></a></td>
        </tr>
        <tr>
            <td>#E-Nov4-5</td>
            <td class="text-center"><strong>5 Units</strong></td>
            <td class="price text-center">€ 1400.00</td>
            <td class="text-end pe-3"><a class="btn btn-primary" href="/inquiry?ref=K0709-01-2&amp;product=Human UMP-CMP Kinase - 5 Unit">Inquiry <i class="fa-solid fa-comment"></i></a></td>
        </tr>
    </tbody>
</table>
