    ...
    <section class="container">
        ...
        <div class="table-responsive">
            <table class="nucleotides-table w-100 table table-hover" aria-label="Validated Assays for Nucleotide Synthesis Inhibition">
                ...
                <tbody>
                    <tr>
                        <td class="table-side"><a href="#Cellular Assay for IMPDH inhibitors">Cellular Assay for IMPDH inhibitors</a></td>
                        <td>
                    ...
                    <tr>
                        <td class="table-side"><a href="#Cellular Assay for RNR inhibitors">Cellular Assay for RNR inhibitors</a></td>
                        <td>
                    ...
                    <tr>
                        <td class="table-side"> <a href="#Cellular Assay for Antifolates">Cellular Assay for Antifolates</a></td>
                        <td>
                ...
                <div class="col-lg-10 col-12">
                    ...
                    <div class="table-responsive">
                        <table class="table product mb-2">
                            ...
                            <tbody>
                                <tr>
                                    <td class="d-none d-md-table-cell">#S1200-04</td>
                                    <td class="text-center">HPLC-UV analysis for full spectra of cellular nucleotides <br> (bases, nucleosides, NMP, NDP and NTP) in cell extracts.<br></td>
                                    <td class="d-none d-md-table-cell text-center">350.00 €</td>
                                    <td class="text-end pe-3">
                                        <div class="d-block d-md-none text-end mb-1 fw-bold">
                                            350.00 € </div>
                                        <a class="btn btn-primary" href="/inquiry?ref=S1200-04&amp;price=350&amp;product=HPLC-UV analysis for full spectra of cellular nucleotides (bases, nucleosides, NMP, NDP and NTP) in cell extracts.">
                    ...
                    <p class="text-muted text-center">
                        <em>Updated on September 29th, 2025.</em><br>
                    </p>
        ...
        <section class="bg-light mt-4 py-2" id="Cellular Assay for IMPDH inhibitors">
            <div class="container">
                <h2 class="underlinedTitle center mb-4" style="margin-bottom: 0">
        ...
        <section class="container mt-4" id="Cellular Assay for RNR inhibitors">
            <h2 class="underlinedTitle center mb-4" style="margin-bottom: 0">
        ...
        <section class="bg-light mt-4 py-3" id="Cellular Assay for Antifolates">
            <div class="container">
                <h2 class="underlinedTitle center mb-4" style="margin-bottom: 0">
