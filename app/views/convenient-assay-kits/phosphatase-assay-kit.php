...
$content_title = UnderlinedTitle::get("Continuous Phosphatase Assay", "novoblue", "right");
...
<div class="row">
    ...
    <div class="row">
        ...
        <div class="col-lg-9 d-flex justify-content-center">
            <ul class="py-3">
                <li>
                    The IMP is immediately transformed into NADH2 in a quantitative manner allowing for accurate kinetic
                    analysis
                </li>
            </ul>
        </div>
        <div class="col-lg-3 text-center bg-light pt-3">
            <h4 class="novo-blue">Continuous</h4>
        </div>
        <div class="col-lg-9 bg-light d-flex justify-content-center">
            <ul>
                <li>Activity is measured through continuous montoring of absorbance at 340nm</li>
            </ul>
        </div>
        <div class="col-lg-3 text-center pt-3">
            <h4 class="novo-blue">Convenient</h4>
        ...
        <div class="col-lg-9 d-flex justify-content-center">
            <ul class="">
                <li>Tolerant to contamination of ware and reagents by inorganic phosphate</li>
                <li>Homogenous</li>
                <li>Non radioactive</li>
                <li>Wide pH range</li>
        ...
        <div class="col-lg-9 bg-light d-flex justify-content-center">
            <ul>
                <li>Wide linearity range (5-300µM)</li>
            </ul>
        </div>
        <div class="col-lg-3 text-center pt-3">
            <h4 class="novo-blue">High-Throughput Analysis</h4>
        </div>
        <div class="col-lg-9 d-flex justify-content-center">
            <ul class="">
                <li>The assay is performed in standard multi-well microplates</li>
                <li>Non Readout is peformed with plate reader fitted with 340nm filter</li>
            </ul>
        </div>
        <div class="col-lg-3 text-center pt-3">
            <h4 class="novo-blue">Specific</h4>
        </div>
        <div class="col-lg-9 d-flex justify-content-center">
            <ul class="py-3">
                <li>Only inorganic phosphate is quantified</li>
            </ul>
        </div>
    </div>
</div>
</main>
CONTENT; addContent($page_content); render(); ?>
