...
global $path_way;
$path_way = ["home", "Freshness Assay Kits"];
...
<div>
<img class="w-100" src="/app/static/img/atp_catabolism_freshness.jpg" alt="atp catabolism freshness cycle">
</div>
...
<li>R²=0.88 found between H-value measured with <a href="">PRECICE® Nucleotides Assay Kit <br>and TMA/ABVT in whiting fillets (11 samples)</a></li>
</ul>
